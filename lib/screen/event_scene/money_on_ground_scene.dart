...
/// 地上有钱事件场景
class MoneyOnGroundScene extends BaseScene with RiverpodComponentMixin {
  // 使用默认背景
  @override
  ...
  Future<void> _loadAndShowEvent() async {
    try {
      ...
      final String jsonString = await rootBundle.loadString(
        'assets/data/money_on_ground_event.json',
      );
      ...
      print('Error loading money on ground event: $e');
    }
  }
