...
/// 老奶奶过马路事件场景
class GrandmaCrossingScene extends BaseScene with RiverpodComponentMixin {
  // 使用默认背景
  @override
  ...
  Future<void> _loadAndShowEvent() async {
    try {
      ...
      final String jsonString = await rootBundle.loadString(
        'assets/data/grandma_crossing_event.json',
      );
      ...
      print('Error loading grandma crossing event: $e');
    }
  }
